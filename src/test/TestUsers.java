...
public class TestUsers {
	...
	public static void testEmployee() {
		...
		{
			System.out.println(newManager.getBranch().getEmployeeList().get(i).getName());
			System.out.println(newManager.getBranch().getEmployeeList().get(i).getSurname());
			System.out.println(newManager.getBranch().getEmployeeList().get(i).getSalary());
			System.out.println(newManager.getBranch().getEmployeeList().get(i).getDateOfBirth());
			System.out.println(newManager.getBranch().getEmployeeList().get(i).getAddress().getCity());
			System.out.println("=========================================");
